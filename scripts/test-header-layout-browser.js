(() => {
  ...
  for(const button of buttons) {
    ...
    if(bounds.width!==30 || bounds.height!==30 || bounds.top<rect.top || bounds.bottom>rect.bottom ||
  ...
  return 'PASS rendered image header: 46px bar, contained 30px SVG controls, light title';
})();
